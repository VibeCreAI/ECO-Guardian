...
const getPropScale = (type: string) => {
    ...
    if (type.includes('STONE') || type.includes('ROCK') || type === 'VINE' || type === 'BOTTLE_PILE' || type === 'BONE_TRASH_PILE' || type === 'FROZEN_CABLE_PILE' || type === 'CABLE_ROOTS' || type === 'SLUDGE_POOL' || type === 'EMBER_VENT') return 1.8;
    return 2.0;
};
